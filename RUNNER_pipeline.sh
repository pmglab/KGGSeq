...
--runner-coding-gene-cov mu_mis,mu_lof,oe_mis,oe_lof,ExonGC #Perform RUNNER by cosidering these covariables
--db-score dbnsfp #Use functional or deleterious scores collected in dbNSFP database
--disease-causing-predict best #Predict combinatorial function score of variants by Logistic regression model implemented in KGGSeq
